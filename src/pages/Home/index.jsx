...
const Home = () => {
  ...
  const { restaurants, restaurantSelect } = useSelector((state)=> state.restaurants);
  ...
  return (
     ...
     <Container>
      <Search>
        ...
        {restaurants.length > 0 ? (
            <>
            <CarouselTitle>Proximo a você</CarouselTitle>
        <Carousel {...settings}>
   ...
   <Modal open={modalOpened} onClose={() => setModalOpened(!modalOpened)}>
     ...
     <ModalContent>{restaurantSelect?.opening_hours?.open_now
